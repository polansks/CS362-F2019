...
/* This program will unit test the ambassadorEffect function that was created */
...
int main()
{
	printf("--------Testing ambassadorEffect function---------\n\n");
	...
	printf("Testing invalid choice2 value of -1\n");
	{
		...
		returnValue = ambassadorEffect(&gameAfter, choice1, choice2, handPos, whoseTurn(&gameAfter));
