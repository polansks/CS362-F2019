...
/* This program will unit test the minionEffect function that was created     */
...
int main()
{
	printf("--------Testing minionEffect function---------\n\n");
	...
	printf("Testing option of +2 coins\n");
	{
		...
		choice1 = 1;
		choice2 = 0;
		returnValue = minionEffect(handPos, &gameAfter, whoseTurn(&gameAfter), choice2, choice1);
