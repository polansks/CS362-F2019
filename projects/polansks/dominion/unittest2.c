...
/* This program will unit test the playMine function that was created       */
...
int main()
{
	printf("--------Testing playMine function---------\n\n");
	...
	printf("Testing invalid value for choice1 - trashing a Duchy card instead of a Treasure card\n");
	{
		...
		returnValue = playMine(choice1, choice2, &gameAfter, handPos);
